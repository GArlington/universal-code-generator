 ...
 */
public class BCXJTreePropertiesTableModel extends AbstractTableModel implements TreeSelectionListener  {
     // Header for the table -
    private String[] _strTableHeaderArr = {"BCX property","Property value"};
    ...
    public BCXJTreePropertiesTableModel()
    {
        data[0][0]=" ";
        data[0][1]=" ";
        data[1][0]=" ";
    ...
    public void valueChanged(TreeSelectionEvent e)
    {
        ...
        if (selectedNode!=null)
        {
            ...
            // Ok, when I get here get the underlying XML node and run through its props -
            ...
            if (NUM_OF_ATTRIBUTES>0)
            {
            	for (int index=0;index<NUM_OF_ATTRIBUTES;index++)
            	{
            		...
            		setValueAt(attributeNode.getNodeName(),index,0);
            		setValueAt(attributeNode.getNodeValue(),index,1);
            	}
            }
            else
            {

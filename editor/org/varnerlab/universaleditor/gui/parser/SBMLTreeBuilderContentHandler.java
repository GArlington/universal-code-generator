 ...
 */
public class SBMLTreeBuilderContentHandler extends ADFBuilderHandler {

    public SBMLTreeBuilderContentHandler(ADFParser parser)
    {
        super(parser);
   ...
   public void endElement(String strElementName,String str3,String str2) throws SAXException {
        ...
        try {
           if (!str2.equalsIgnoreCase("sbml")){
               ...
               if (comp instanceof VLDomainComposite){
                   ...
                   PublishService.submitData("Spank - "+comp);
               }
           }
       }
    ...
    public void startElement(String URI, String rawName, String localName, Attributes attributes) throws SAXException {
        ...
        try {
            ...
            if (!localName.equalsIgnoreCase("sbml")){
                ...
                m_package.append("org.varnerlab.universaleditor.domain.sbml.");
    ...
    private VLDomainComponent checkParent(VLDomainComponent obj){
        ...
        try {
            ...
            // If the root is null -- then we are at the first element. Grab it.
            if (m_akoRoot == null)
            {

                // If I get here then I have the root -
                m_akoRoot = obj;
            }

...
public class LoginTool extends javax.swing.JInternalFrame {
    ...
    public LoginTool() {
        ...
        jPanel1.setBackground(new Color(100,100,100, 130));
    }
    ...
    private void checkUserNameAndPassword(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkUserNameAndPassword
        ...
        if (!isOkToLogin)
        {
            PublishService.submitData("Hey monkey spank - what is your major ducking malfunction?");
        ...
        else
        {
            ...
            if (jCheckBox1.isSelected())
            {
                ...
                remoteDir.setProperty("PORT", session.getProperty("DIRECTORY_SERVER_PORT"));
                ...
                try {
                    ...
                    String strPort = (String)session.getProperty("DIRECTORY_SERVER_PORT");

                    PublishService.submitData("Trying to contact - "+strIPAddress+" on port "+strPort);

                    String rFlag = SocketService.sendMessage(strMsg, strIPAddress, strPort,session);
                    ...
                    // Update the database -
                    String strSessionID = "ssid_"+(String)session.getProperty("SESSION_ID");

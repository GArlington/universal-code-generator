...
public class OpenProjectViewAction implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e){
       ...
       // Set the frameIcon
       _tool.setFrameIcon(VLIconManagerService.getIcon("PROJECT-18-GREY-ICON"));
        
        
        // Ok, we need to store the icons on the tool so I can switch w/out loading -
        _tool.setOffIcon(VLIconManagerService.getIcon("PROJECT-18-GREY-ICON"));
        _tool.setOnIcon(VLIconManagerService.getIcon("PROJECT-18-ICON"));

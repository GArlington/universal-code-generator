...
public class LoginToolAction implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e){
       ...
       // Set the frameIcon
        _tool.setFrameIcon((new ImageIcon(VLImageLoader.getPNGImage("Login-32-Grey.png"))));

        // Ok, we need to store the icons on the tool so I can switch w/out loading -
        _tool.setOffIcon((new ImageIcon(VLImageLoader.getPNGImage("Login-32-Grey.png"))));
        _tool.setOnIcon((new ImageIcon(VLImageLoader.getPNGImage("Login-32.png"))));
